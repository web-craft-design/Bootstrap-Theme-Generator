  ...
  var K = {
      ...
      trigger: function (t, e, n) {
        ...
        return (
          ...
          a ? (h = document.createEvent("HTMLEvents")).initEvent(s, l, !0) : (h = new CustomEvent(e, { bubbles: l, cancelable: !0 })),
          void 0 !== n &&
          ...
          if (s && s.classList.contains("active")) this._isSliding = !1;
            ...
            if (((this._isSliding = !0), a && this.pause(), this._setActiveIndicatorElement(s), (this._activeElement = s), this._element.classList.contains("slide"))) {
              ...
              K.one(i, "transitionend", function () {
                ...
                m(i, h);
            } else i.classList.remove("active"), s.classList.add("active"), (this._isSliding = !1), K.trigger(this._element, "slid.bs.carousel", { relatedTarget: s, direction: u, from: o, to: r });
            a && this.cycle();
          }
        }),
    ...
    dt = (function (e) {
      ...
      return (
        ...
        (a.hide = function () {
          if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
            ...
            K.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented ||
              (this._popper && this._popper.destroy(), this._menu.classList.toggle("show"), this._element.classList.toggle("show"), X.removeDataAttribute(this._menu, "popper"), K.trigger(this._element, "hidden.bs.dropdown", t));
          }
        }),
        (a.dispose = function () {
        ...
        (a._getConfig = function (t) {
          if (((t = s({}, this.constructor.Default, X.getDataAttributes(this._element), t)), _("dropdown", t, this.constructor.DefaultType), "object" == typeof t.reference && !g(t.reference) && "function" != typeof t.reference.getBoundingClientRect))
        ...
        (a._getPopperConfig = function () {
          ...
          return "static" === this._config.display && (t.modifiers = [{ name: "applyStyles", enabled: !1 }]), s({}, t, "function" == typeof this._config.popperConfig ? this._config.popperConfig(t) : this._config.popperConfig);
        }),
            ...
            for (var e = q('[data-bs-toggle="dropdown"]'), n = 0, i = e.length; n < i; n++) {
              ...
              if ((t && "click" === t.type && (s.clickEvent = t), o)) {
                ...
                if (
                  ...
                  !((t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && "Tab" === t.key)) && a.contains(t.target)) || K.trigger(e[n], "hide.bs.dropdown", s).defaultPrevented)
                )
                  "ontouchstart" in document.documentElement &&
        ...
        (i.dataApiKeydownHandler = function (t) {
          if (
            !(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || ("Escape" !== t.key && (("ArrowDown" !== t.key && "ArrowUp" !== t.key) || t.target.closest(".dropdown-menu"))) : !it.test(t.key)) &&
        ...
        (a.setElementContent = function (t, e) {
          if (null !== t)
            return "object" == typeof e && g(e)
              ...
              : void (this.config.html ? (this.config.sanitize && (e = bt(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
        }),
        (a.getTitle = function () {
      ...
      return (
        ...
        (n._activate = function (t) {
          ...
          n.classList.contains("dropdown-item")
            ? (Q(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active"))
